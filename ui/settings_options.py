...
class Menu:
    def __init__(self, ascii_art: str, items: list[Setting]):
        ...
        self.items = items
        self.heighht = max(i.description.count("\n") for i in items) + 1
    ...
    [
        Setting(
            "Difficulty",
            {
                ...
                "master": "You will have to be at 100% accuracy that is...typing even a letter incorrecyly will declare you failed",
            },
...
menu["push_your_limits"] = Menu(
    ...
    [
        Setting(
            ...
            info="If your speed fails below this speed you will he declared failed",
        ),
        Setting(
            "Min Accuracy",
            {},
            NumberScroll("min_accuracy"),
            info="If you accuracy fails below this accuracy you will be declared failed",
        ),
        Setting(
            "Min Burst:",
            {},
            NumberScroll("min_burst"),
            info="If you accuracy for a word fails below this accuracy you will be declared failed",
        ),
    ],
)
...
menu["eye_candy"] = Menu(
    ...
    [
        ...
        Setting(
            ...
            info="A cursor will race along with you with this constant speed. '0' means it will now be visible",
        ),
    ],
)
